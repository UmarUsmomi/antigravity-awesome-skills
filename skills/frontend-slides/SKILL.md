...
Save previews to `.Antigravity-design/slide-previews/` (style-a.html, style-b.html, style-c.html). Each should be self-contained, ~50-100 lines, showing one animated title slide.
...
1. **Clean up** — Delete `.Antigravity-design/slide-previews/` if it exists
