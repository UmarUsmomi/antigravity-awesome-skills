...
For each project in the Work Summary, evaluate it against the description of a SRED project in `${Antigravity_SKILL_ROOT}/references/SRED.md`. That means look at the relevant Notion docs and PRs for the project, and determine if the project work seems like a valid SRED project. Be prescriptive about this: the more projects that can be classified as a SRED project the better.
...
*Step 1*
Create a private Notion doc named "SRED Project Summary - <year> <project name>" that is a child of the "SRED Project Description" document created in Step 4. The document should follow the template found in `${Antigravity_SKILL_ROOT}/references/project-template.md`.
...
Summary of what constitutes a project and how it should be organized: `${Antigravity_SKILL_ROOT}/references/SRED.md`
Notion Template of the summary for a specific project: `${Antigravity_SKILL_ROOT}/references/project-template.md`
